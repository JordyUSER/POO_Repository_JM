 ...
 * @author appka
 */
public class viewProfesor extends JInternalFrame {
    
    MongoConnection con = new MongoConnection();
    MongoDatabase cc = con.conectar();
    
    JTextField txtCodigo, txtCedula, txtApellido, txtNombre, txtMail, txtTelefono, txtTitulo;
    ...
    public void colocarEtiquetas(){
        JLabel label = new JLabel("Profesor", SwingConstants.CENTER); //Crea un nuevo label
        ...
        JLabel label8 = new JLabel("Titulo:"); //Label de Direccion
    ...
    public void colocarCajaTxt(){
        ...
        txtTitulo.setBounds(130,215,100,25);
        panel.add(txtTitulo);
        txtTitulo.setText("");
    ...
    public void mostrarDatos(){
        ...
        MongoCollection<Document> collection = cc.getCollection("profesores");
        // Obtener todos los documentos de la colección
        FindIterable<Document> documents = collection.find();
        
        String titulos[] = {"ID", "Codigo", "Cedula", "Apellido", "Nombre", "Mail", "Telefono", "Titulo", "Materia", "Estado"};
        ...
        try (MongoCursor<Document> cursor = documents.iterator()) {
            while(cursor.hasNext()){
                ...
                registro[7] = document.getString("Titulo");
    ...
    private void boton2ActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        if (code == null || CI == null || lastName == null || firstName == null || email == null || phone == null || titulo == null){
