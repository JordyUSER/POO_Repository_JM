 ...
 * @author JordyUSER
 */
public class viewProfesor extends javax.swing.JInternalFrame {
    ...
    public void mostrarDatos(){
         ...
         try {
             ...
             while(rs.next()){
                ...
                registro[1] = rs.getString("profCedula");
                registro[2] = rs.getString("profNombre");
                registro[3] = rs.getString("profApellido");
                registro[4] = rs.getString("profCelular");
                registro[5] = rs.getString("profMail");
                registro[6] = rs.getString("profTitulo");
                registro[7] = rs.getString("profEstado");
    ...
    private void initComponents() {
        ...
        CBEstado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tiempo Completo", "Medio Tiempo", "Ocasional" }));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 0, 500, 460));
    ...
    private void bottAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bottAgregarActionPerformed
        String SQL = "INSERT INTO profesor(profCedula, profNombre, profApellido, profCelular, profMail, profTitulo, profEstado)values(?,?,?,?,?,?,?)";
        try {
    ...
    private void bottEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bottEditarActionPerformed
        try {
            String SQL = "UPDATE profesor set profCedula = ?, profNombre = ?, profApellido = ?, profCelular = ?, profMail = ?, profTitulo = ?, profEstado = ? where id = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewProfesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
