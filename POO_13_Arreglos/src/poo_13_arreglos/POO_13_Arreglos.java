        ...
        do {
            ...
            switch(option){
                case 1:
                    ...
                    do {
                        if (option2 == 0) {
                            n = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la cantidad de numeros que desee tenga el arreglo numerico: "));
                            obj1.setnNumeros(n);
                            obj1.establecerArr();
                        }
                ...
                case 2:
                    ...
                    do {
                        if (option3 == 0) {
                            tam = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la cantidad de numeros que desee tenga el arreglo de nombres: "));
                        ...
                        switch(option3){
                            case 1:
                                ...
                                break;
                            case 2:
                                System.out.println("La cantidad de nombres dentro del arreglo es: " + obj1.arrNombresSize());
                                break;
                            case 3:
                            flag2 = 1;
                            option3 = 0;
